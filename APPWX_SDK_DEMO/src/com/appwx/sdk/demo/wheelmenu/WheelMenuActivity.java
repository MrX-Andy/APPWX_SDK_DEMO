...
*
*/
        final WheelMenu wm = new WheelMenu(WheelMenuActivity.this, 12, R.drawable.wheel, wheel_image, true);
        ...
        show_selected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(WheelMenuActivity.this, "selected: " + wm.getSelected(), Toast.LENGTH_SHORT).show();
            }
        });
